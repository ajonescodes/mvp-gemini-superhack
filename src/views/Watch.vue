  ...
  <div class="min-h-screen bg-slate-900 py-8 px-4">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="text-center mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Watch the Action</h1>
        <p class="text-slate-400">AI-generated anime-style trailer</p>
      </div>
      ...
      <div v-else-if="!videoUrl" class="text-center py-20">
        ...
        <h2 class="text-xl text-white mb-2">Video Coming Soon</h2>
        <p class="text-slate-400 mb-4">
          {{ matchups.hasActiveMatchup 
            ? 'The trailer is being generated. Check back soon!' 
      ...
      <div v-else>
        ...
        <div class="card mb-8">
          ...
          <p class="text-slate-400">
            This anime-style trailer was generated by AI based on community predictions. 
            The outcomes were determined by your votes!
          </p>
        </div>
